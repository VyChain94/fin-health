  ...
  return <Card className="shadow-lg border-primary/10 bg-gradient-to-br from-card to-card/80">
      <CardHeader className="bg-primary text-primary-foreground rounded-t-lg">
        <div className="flex items-center justify-between">
          ...
          <DataSourceDropdown sectionName="Expenses" dataSources={dataSources} onAddSource={onAddSource} onRemoveSource={onRemoveSource} onUpdateSource={onUpdateSource} />
        </div>
      </CardHeader>
          ...
          <div className="grid grid-cols-2 gap-2 items-center">
            <div className="flex items-center gap-1">
              ...
              <Popover>
                ...
                <PopoverContent className="w-80">
                  <p className="text-sm">Food/Clothing/Entertainment</p>
                </PopoverContent>
              </Popover>
            </div>
